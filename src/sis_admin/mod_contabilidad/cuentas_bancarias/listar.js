...
function Ver(variables, paginas, pagina_actual, _escritura){
    ...
    var tab = yo`
    <li class=""><a href="#tab_listar_cuentas_bancarias_2" data-toggle="tab" aria-expanded="false" id="id_tab_listar_cuentas_bancarias_2">Cuentas Bancarias<a style="padding-left: 10px;font-size:15px" onclick=${()=>CerrarTab()}><i class="zmdi zmdi-close"></i></a></a></li>`
