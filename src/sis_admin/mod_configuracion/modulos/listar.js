...
function Ver(modulos, paginas,pagina_actual, _escritura,raices) {
    ...
    var tab = yo`
    <li class=""><a href="#tab_listar_modulos_2" data-toggle="tab" aria-expanded="false" id="id_tab_listar_modulos_2">Modulos<a style="padding-left: 10px;font-size:15px"   onclick=${()=>CerrarTab()}><i class="zmdi zmdi-close"></i></a></a></li>`
                ...
                <header>Lista de Modulos</header>
                    <ul class="actions">
                        ...
                        ${_escritura ? yo`<a onclick=${()=>NuevoModulo(_escritura, raices)} class="btn btn-info pull-right">
                            <i class="zmdi zmdi-plus"></i> Nuevo Modulo</a>`: yo``}
                        </li>
                    </ul>
                </div> 
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ${_escritura ? yo`<button class="btn btn-xs btn-success" onclick="${()=>NuevoModulo(_escritura,raices, u)}"><i class="zmdi zmdi-edit"></i></button>` : yo``}
                                    ${_escritura ? yo`<button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modal-danger-modulos" onclick="${()=>Eliminar(_escritura, u)}"><i class="zmdi zmdi-delete"></i></button>` : yo``}
