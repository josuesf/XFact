...
function Ver(empresa, _escritura) {
    ...
    var tab = yo`
    <li class=""><a href="#tab_listar_empresas_2" data-toggle="tab" aria-expanded="false" id="id_tab_listar_empresas_2">Empresas<a style="padding-left: 10px;font-size:15px"  onclick=${()=>CerrarTab()}><i class="zmdi zmdi-close"></i></a></a></li>`
