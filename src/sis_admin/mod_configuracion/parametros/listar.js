...
function Ver(parametros, paginas,pagina_actual, _escritura) {
    ...
    var tab = yo`
    <li class=""><a href="#tab_listar_parametros_2" data-toggle="tab" aria-expanded="false" id="id_tab_listar_parametros_2">Parametros<a style="padding-left: 10px;font-size:15px"  onclick=${()=>CerrarTab()}><i class="zmdi zmdi-close"></i></a></a></li>`
