...
module.exports = function NuevoPerfil(_escritura,modulos, perfil) {
    ...
    var tab = yo`
    <li class=""><a href="#tab_crear_parametros_2" data-toggle="tab" aria-expanded="false" id="id_tab_crear_paramtros_2">Nuevo Parametro<a style="padding-left: 10px;font-size:15px" onclick=${()=>CerrarTab()}><i class="zmdi zmdi-close"></i></a></a></li>`
