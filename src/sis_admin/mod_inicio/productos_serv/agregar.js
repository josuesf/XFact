...
function Ver(_escritura, variables, producto){
    ...
    var tab = yo`
    <li class=""><a href="#tab_crear_producto_2" data-toggle="tab" aria-expanded="false" id="id_tab_crear_producto_2">Agregar Productos y Servicios <a style="padding-left: 10px;font-size:15px" onclick=${()=>CerrarTab()} ><i class="zmdi zmdi-close"></i></a></a></li>`
