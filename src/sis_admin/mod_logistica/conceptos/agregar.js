...
function NuevoConcepto(_escritura, tipos_conceptos, concepto) {
    ...
    var tab = yo`
    <li class=""><a href="#tab_crear_concepto_2" data-toggle="tab" aria-expanded="false" id="id_tab_crear_concepto_2">Nuevo concepto<a style="padding-left: 10px;font-size:15px" onclick=${()=>CerrarTab()}><i class="zmdi zmdi-close"></i></a></a></li>`
